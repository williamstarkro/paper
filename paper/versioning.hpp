...
public:
	...
	pending_info_v3 (paper::account const &, paper::amount const &, paper::account const &);
	void serialize (paper::stream &) const;
	bool deserialize (paper::stream &);
...
public:
	...
	account_info_v5 (paper::block_hash const &, paper::block_hash const &, paper::block_hash const &, paper::amount const &, uint64_t);
	void serialize (paper::stream &) const;
	bool deserialize (paper::stream &);
	paper::mdb_val val () const;
	paper::block_hash head;
