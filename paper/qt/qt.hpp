...
namespace paper_qt {
    ...
    {
    public:
        password_change (paper_qt::client &);
        void clear ();
        QWidget * window;
        QVBoxLayout * layout;
    ...
    {
    public:
        enter_password (paper_qt::client &);
        void activate ();
        void update_label ();
        QWidget * window;
        QVBoxLayout * layout;
    ...
    {
    public:
        advanced_actions (paper_qt::client &);
        QWidget * window;
        QVBoxLayout * layout;
        ...
        paper::uint128_t const scale;
        uint64_t scale_down (paper::uint128_t const &);
        paper::uint128_t scale_up (uint64_t);
    ...
    {
    public:
        client (QApplication &, paper::client &);
        ~client ();
        paper::client & client_m;
        paper_qt::password_change password_change;
        paper_qt::enter_password enter_password;
